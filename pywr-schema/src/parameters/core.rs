...
impl MaxParameter {
    ...
    pub fn add_to_model(
        ...
        let idx = self.parameter.load(network, domain, tables, data_path)?;
...
impl DivisionParameter {
    ...
    pub fn add_to_model(
        ...
        let n = self.numerator.load(network, domain, tables, data_path)?;
        let d = self.denominator.load(network, domain, tables, data_path)?;
