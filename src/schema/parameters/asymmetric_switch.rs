...
use pywr_schema::parameters::AsymmetricSwitchIndexParameter as AsymmetricSwitchIndexParameterV1;
...
impl AsymmetricSwitchIndexParameter {
    ...
    pub fn add_to_model(
        ...
        let p = crate::parameters::AsymmetricSwitchIndexParameter::new(
            &self.meta.name,
            on_index_parameter,
            off_index_parameter,
        );
